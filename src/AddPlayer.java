...
class AddPlayer implements ActionListener{
    ...
    AddPlayer(){
        ...
        id15.setLayout(null);
        ImageIcon img = new ImageIcon(ClassLoader.getSystemResource("Icons/add.jpg"));
        id15.setIcon(img);

        id8 = new JLabel("New Player Details");
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        String player_id = t10.getText();
        String cnic = t11.getText();
        if(ae.getSource() == b){
            try{
                Conn cc = new Conn();
                String q =String.format("INSERT INTO `player` (`Name`, `Father's Name`, `Age`, `Date of Birth`, `Address`, `Email Id`, `Education`, `Player Id`, `CNIC`, `Phone`) VALUES ('%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s')",name,fathers_name,
                        age,date_of_birth,address,phone,email_id,education,player_id,cnic);
